...
<html class="no-js" lang="zxx">
    ...
    <script type="text/javascript">  
        ...
        if (feedback===""){
            Swal.fire("Feedback cannot be blank");            
            return false;
        }
    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-12 col-md-8 col-lg-6">
                <div class="card p-4">
                    <h4 class="text-center mb-4">Please rate your experience with us</h4>
<form action="feedbackAction.jsp" method="POST" id="myform" onsubmit="return validateuser()" name="myform" class="contactForm">
                   
                        <div class="form-group">
                            <!-- Rating label -->
                            <label for="star1"><b>Rating:</b></label>&nbsp &nbsp  &nbsp

                            <!-- Star rating -->
                            <div class="star-rating">
                                <input type="radio" name="star1" value="1"><i></i>
                                <input type="radio" name="star1" value="2"><i></i>
                                <input type="radio" name="star1" value="3"><i></i>
                                <input type="radio" name="star1" value="4"><i></i>
                                <input type="radio" name="star1" value="5"><i></i>
                            </div>
                        </div>

                        <div class="form-group">
                            <!-- Feedback text area -->
                            <label for="commentText"><b>Any other suggestions:</b></label>
                            <textarea class="form-control" name="feedback" id="feedback" rows="5"></textarea>
                        </div>

                        <!-- Submit button -->
                        <button class="btn btn-primary btn-block" type="submit">Submit your review</button>
                    </form>
                </div>
            </div>
        </div>
