...
<head>
    ...
    <style>
        ...
        /* Add a style block for additional styling */
        .solid-box {
        ...
        /* Style to center the content within the solid box */
        .login-container {
            display: flex;
        ...
        .form-control {
            border-radius: 25px;
            /* Add border-radius for rounded inputs */
            margin-bottom: 15px;
        }
        ...
        .btn-primary {
            ...
            font-size: 16px;
            border-radius: 25px;
            /* Add border-radius for rounded button */
        }
        ...
        <div class="container">
            <div class="row no-gutters slider-text align-items-center justify-content-center">
                <div class="col-md-9 ftco-animate text-center">
                    <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home</a></span> <span>User</span></p>
            ...
            <div class="col-12 pr-5" style="border: 1px solid #000000;">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-5 ml-auto p-5" style="" >
                        <form action="user-loginAction.jsp" method="POST" id="myform" onsubmit="return validateuser()" name="myform" class="contactForm">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-7">
                        <div class="single-footer-caption mb-50">
                            ...
                            <div class="footer-logo">
                                <a href="index.html"><img src="assets/img/hero/pcub9.png" height="100" width="200"
                                        alt=""></a>
                            </div>
                            <div class="single-footer-caption mb-30">
                                <div class="footer-tittle">
                                    <div class="footer-pera">
                                        <p>Using blockchain technology in the context of police complaints can
                                            bring about several potential benefits, largely centered around
                                ...
                                <div class="block-23 mb-3">
                                    <ul>
                                        <li><span class="icon icon-map-marker"></span><span
                                                class="text">#2nd Floor, Siris Rd, Near L.B Nagar Metro Station Pillar
                                                No, A1662, Snehapuri Colony, Hyderabad, Telangana 500074</span></li>
                                        <li><a href="#"><span class="icon icon-phone"></span><span
                                                    class="text">+91 9848022602</span></a></li>
                                        <li><a href="#"><span class="icon icon-envelope"></span><span
                                                    class="text">codebook@gmail.com</span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-12">
                            <div class="footer-copy-right text-center">
                                <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                                    ...
                                    rights reserved | </i> by <a href="https://codebook.in/"
